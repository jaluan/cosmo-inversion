function [gm] = forward_bedrockvJ1_mn4_BeAl(up,model,CNprop)
...
for i=1:model.Nsnr
    ...
    dOn = interp1(dOt,dO,time,'linear',dO(end)); %climat curve values at times in 'time'
...
%             P21z_m1 = pf*P21m2*exp(-rho*100*bz/P21Lm2);
%             P21z_m2 = pf*P21m1*exp(-rho*100*bz/P21Lm1);
% 
